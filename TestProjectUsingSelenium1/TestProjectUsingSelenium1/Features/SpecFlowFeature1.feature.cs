...
#line hidden
	...
	Fill in the text boxes.", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void CreateNewAccount(string userFirstNameValue, string userLastNameValue, string userEmailValue, string userPasswordValue, string userAddressFirstNameValue, string userAddressLastNameValue, string userAddressValue, string userCityValue, string userZipCodeValue, string userMobilePhoneValue, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("CreateNewAccount", null, tagsOfScenario, argumentsOfScenario);
#line 9
...
#line 11
 testRunner.Then("I fill in the email and click register", ((string)(null)), table1, "Then ");
#line hidden
...
#line 14
 testRunner.When("I fill in the text boxex with following data", ((string)(null)), table2, "When ");
#line hidden
#line 17
